...
1. All unit tests must be 100% green. No notices, warnings or skips allowed.
2. Tests must not have external dependencies such as a real database connection.
   Use, extend or amend the existing mocks and stubs.
3. Maintain the [changelog](CHANGELOG.md).
